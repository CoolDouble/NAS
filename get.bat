...
mkdir %USERPROFILE%\Desktop\Steam\extracted
...
echo $SteamExtractPath = "extracted" >> install.ps1
...
echo $sevenResponse2 = Invoke-WebRequest -Uri $sevenURL2 -outfile "7z.dll" >> install.ps1
